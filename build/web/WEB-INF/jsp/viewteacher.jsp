...
<html>
    ...
    <div class="panel panel-default">
      	<div class="panel-heading"><h1><center><span class="glyphicon glyphicon-th-list"></span>The List of Teacher</center></h1></div>
        <div class="panel-body">
        
        <form >
            <table class="table table-curved" border="3">
                <tr bgcolor="C6FFCC" bordercolordark="#333333">
                    <th bgcolor="AAFFB1">Teacher id</th>
                    <th>Teacher name</th>
                    ...
                    <c:forEach items="${teacherlist}" var="s">
                        <tr>   
                        <td>${s.teacherid}</td>
                        <td>${s.tfirstname} ${s.tlastname}</td>
                        <td>${s.tcontact}</td>
                        <td>${s.taddress}</td>
                        <td>${s.temail}</td>
                        <td>${s.tpassword}</td>
                        <td> <a href="${pageContext.servletContext.contextPath}/deleteteacher/${s.teacherid}">delete</a></td>
                         </tr>
                    </c:forEach>
