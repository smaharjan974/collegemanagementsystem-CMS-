...
<html>
    ...
    <div class="panel panel-default">
      	<div class="panel-heading"><h1><center><span class="glyphicon glyphicon-th-list"></span>BATCH & SEMESTER</center></h1></div>
        <div class="panel-body">
        
        <form>
            <table class="table table-curved" border="3">
                <tr  bgcolor="C6FFCC" bordercolordark="#333333">
                    <th bgcolor="AAFFB1">BATCH id</th>
                    <th>Semeter id</th>
                    <th bgcolor="AAFFB1">Faculty id</th>
                    
                </tr>
                
                    <c:forEach items="${batchsemlist}" var="batch">
                        <tr>   
                        <td>${batch.batchid}</td>
                        <td>${batch.semesterid}</td>
        ...
        <form action="${pageContext.servletContext.contextPath}/progress" method="post">
            <input type="submit" value="progress to NEXT" />
        </form>
    </body>
</html>
