...
<html>
    ...
    <div class="panel panel-default">
      	<div class="panel-heading"><h1><center><span class="glyphicon glyphicon-th-list"></span>The List of Subject</center></h1></div>
        ...
        <form >
            <table class="table table-curved" border="3">
                <tr bgcolor="C6FFCC" bordercolordark="#333333">
                    ...
                    <th>Subject name</th>
                    <th bgcolor="AAFFB1">Full marks</th>
                    <th>pass marks</th>
                    <th bgcolor="AAFFB1"> delete</th>
                </tr>
                
                    <c:forEach items="${subejctlist}" var="subjectlist">
                        <tr>   
                        <td>${subjectlist.subjectcode}</td>
                        <td>${subjectlist.subjectname}</td>
                        <td>${subjectlist.fullmarks}</td>
                        <td>${subjectlist.passmarks}</td>
                        <td> <a href="${pageContext.servletContext.contextPath}/deletesubject/${subjectlist.subjectcode}">delete</a></td>
                         </tr>
                    </c:forEach>
