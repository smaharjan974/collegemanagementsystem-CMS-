...
<html>
	...
	<div class="panel-heading"><h1><center><span class="glyphicon glyphicon-th-list"></span>View Subject of Semester</center></h1></div>
        ...
        <form>
            <table  class="table table-curved" border="3">
                <tr bgcolor="C6FFCC" bordercolordark="#333333">
                    ...
                    <th>Faculty id</th>
                    <th bgcolor="AAFFB1">Subject code/Subject Name</th>
                </tr>
                <tr>
                    <td>${semid}</td>
                    <td>${fac}</td>
                    <td>
                        <c:forEach items="${sublist}" var="x">
                            ${x.subjectcode} (${x.subjectname})<br>
                        </c:forEach>
                    </td>
                </tr>
            </table>
        ...
        <center><h1> <a href="${pageContext.servletContext.contextPath}/viewbatchsemsub"><input type="button" value="Back"/></a></h1>
    </center>
            </body>
</html>
