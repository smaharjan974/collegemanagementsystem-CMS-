        ...
        <form>
            <table class="table table-curved" border="3">
                <tr bgcolor="C6FFCC" bordercolordark="#333333">
                    ...
                    <th bgcolor="AAFFB1">BATCH name</th>
                    <th>delete</th>
                </tr>
                    ...
                    <c:forEach items="${batchlist}" var="batchlist">
                       ...
                       <td><a href="${pageContext.servletContext.contextPath}/editbatch/${batchlist.batchid}">edit</a>/<a href="${pageContext.servletContext.contextPath}/deletebatch/${batchlist.batchid}">delete</a></td>
                        </tr>
