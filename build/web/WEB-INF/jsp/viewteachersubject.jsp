        ...
        <form>
            <table class="table table-curved" border="3">
                <tr bgcolor="C6FFCC" bordercolordark="#333333">
                    ...
                    <th>Subject code</th>
                    <th bgcolor="AAFFB1">Facultyid</th>
                    <th>Batch</th>
                    <th bgcolor="AAFFB1">delete</th>
                </tr>
                
                    <c:forEach items="${teachersublist}" var="x">
                        <tr>   
                        <td>${x.teacherid}</td>
                        <td>${x.subjectcode}</td>
                        <td>${x.facultyid}</td>
                        <td>${x.batchid}</td>
                        <td><a href="edit">edit</a>/<a href="${pageContext.servletContext.contextPath}/deletesubjecttaught/${x.id}">delete</a></td>
                        </tr>
                    </c:forEach>
