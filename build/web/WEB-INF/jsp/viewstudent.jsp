...
<html>
    ...
    <div class="panel panel-default">
      	<div class="panel-heading"><h1><center><span class="glyphicon glyphicon-th-list"></span>The List of Student</center></h1></div>
        <div class="panel-body">
        <form >
            <table class="table table-curved" border="3">
                <tr bgcolor="C6FFCC" bordercolordark="#333333"> 
                    <th bgcolor="AAFFB1">Student roll</th>
                    <th>Student name</th>
                    <th  bgcolor="AAFFB1">Faculty</th>
                    <th  bgcolor="AAFFB1">Batch</th>
                    <th>Address</th>
                    <th  bgcolor="AAFFB1">Contact</th>
                    <th>Blood Group</th>
                    <th  bgcolor="AAFFB1">Email</th>
                    <th>Guardian's Name</th>
                    <th  bgcolor="AAFFB1">Guardian's Contact</th>
                    <th>Password</th>
                    <th  bgcolor="AAFFB1"> delete</th> 
                </tr>
                
                    <c:forEach items="${studentlist}" var="s">
                        <tr>   
                        <td>${s.roll}</td>
                        <td>${s.sfirstname} ${s.slastname}</td>
                        <td>${s.facultyid}</td>
                        <td>${s.batchid}</td>
                        <td>${s.saddress}</td>
                        <td>${s.contact}</td>
                        <td>${s.bloodgroup}</td>
                        <td>${s.semail}</td>
                        <td>${s.gfirstname} ${s.glastname}</td>
                        <td>${s.contact}</td>
                        <td>${s.password}</td>
                        <td> <a href="${pageContext.servletContext.contextPath}/deletestudent/${s.roll}">delete</a></td>
                         </tr>
                    </c:forEach>
