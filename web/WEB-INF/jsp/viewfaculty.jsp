...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/${pageContext.servletContext.contextPath}/resources/css/style.css">
        ...
        <form>
            <table class="table table-curved" border="3">
                <tr  bgcolor="C6FFCC" bordercolordark="#333333">
                    ...
                    <th>Faculty name</th>
                    <th bgcolor="AAFFB1">no. of semester</th>
                    <th>delete</th>
                </tr>
                    ...
                    <c:forEach items="${facultylist}" var="facultylist">
                        ...
                        <td>${facultylist.semestercount}</td>
                        <td><a href="${pageContext.servletContext.contextPath}/deletefaculty/${facultylist.facultyid}">delete</a></td>
                         </tr>
                    </c:forEach>
