...
<html>
  ...
  <font size="+2">
  <table bordercolordark="#333333">
 <tr>
 <td>Choose Batch</td>
         <td>
          
<select size="0.2px" name="batchid">
    <option>select Batch</option>
    <c:forEach items="${batchlist}" var="x">
...
<td>
        Faculty</td>
        <td>
<select size="0.2px" name="facultyid">
   <option>select Faculty</option>
    <c:forEach items="${faclist}" var="y">
        <option value="${y.facultyid}">${y.facultyid}</option>
    </c:forEach>
</select>
</td>
</tr>
...
<tr>
     <td>  SEMESTER ID</td>
     <td>
<select size="0.2px" name="semesterid">
   <option>select Semester</option>
    <c:forEach items="${semlist}" var="x">
...
<td>
      MARKS</td>
      <td>
<select size="0.2px" name="selectmarks">
    <option>select option</option>
  <option value="internalmarks">INTERNAL</option>
  <option value="boardmarks">BOARD</option>
